const storeCustomization = {
  setting: {
    ...
    home: {
      ...
      promotion_title: {
        en: "Mega Mobile Sale – Grab the Best Deals on Smartphones & Accessories!",
      ...
      quick_delivery_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our AffilCommerce shop and get some special offers. See Our latest discounted products from here and get a special discount.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem AffilCommerce-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
      },
      ...
      daily_need_title: {
        en: "Get Your Daily Needs From Our AffilCommerce Store",
        de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
      },
      daily_need_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our AffilCommerce shop and get some special offers.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem AffilCommerce-Shop und erhalten Sie einige Sonderangebote.",
      },
    ...
    about_us: {
      ...
      top_title: {
        en: "Welcome to our AffilCommerce shop",
        de: "Willkommen in unserem AffilCommerce-Shop",
      },
      top_description: {
    ...
    contact_us: {
      ...
      email_box_email: {
        en: "info@AffilCommerce.com ",
        de: "info@AffilCommerce.com",
      },
      email_box_text: {
    ...
    faq: {
      ...
      faq_one: {
        en: "How does the AffilCommerce work?",
        de: "Wie funktioniert der AffilCommerce?",
      },
      description_one: {
      ...
      faq_five: {
        en: "What is AffilCommerce EC2 auto scaling?",
        de: "Was ist die automatische Skalierung von AffilCommerce EC2?",
      },
      description_five: {
        en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
      ...
      faq_six: {
        en: "What are the benefits of using AffilCommerce affliate?",
    ...
    seo: {
      ...
      meta_url: "https://AffilCommerce-store-nine.vercel.app/",
    },
  },
