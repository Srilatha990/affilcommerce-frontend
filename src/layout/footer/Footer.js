...
//                     {/* Responsive h1 for AffilCommerce */}
//                     <h1
//                       style={{
//                         fontWeight: "bold",
//                         color: "#0b5052",
...
const Footer = () => {
  ...
  return (
    <div
      className="bg-[#1A4B8B] text-white py-10"
      style={{ backgroundColor: "#1A4B8B" }}
    >
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 text-center">
        {/* Logo */}
        <div
          className="mb-6"
          style={{
        ...
        <div className="flex justify-center space-x-8 mb-6 flex-wrap">
          <Link href="/about-us" className="hover:text-orange-300 mb-4 sm:mb-0">
            {t("about-us")}
          </Link>
          <Link href="/contact-us" className="hover:text-orange-300 mb-4 sm:mb-0">
            {t("contact-us")}
          </Link>
          <Link href="/terms-and-conditions" className="hover:text-orange-300 mb-4 sm:mb-0">
            {t("terms-and-conditions")}
          </Link>
          <Link href="/privacy-policy" className="hover:text-orange-300 mb-4 sm:mb-0">
            {t("privacy-policy")}
          </Link>
        </div>
